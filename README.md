...
## M. thermophila Knockout Designer (V2 & V3) - Specialized Implementation

For *Myceliophthora thermophila* (7 chromosomes, ~38.7 Mb, 9,097 genes), this repository provides optimized V2 and V3 implementations of the Cas9-based knockout designer with enhanced performance and synthesis constraints.
...
- **Performance optimized**: PAM search via string matching, reverse complement via string translation (~3 min for 9,097 genes)
- **Flexible parameters**: 
...
| **Speed** | ~3 minutes (full genome) | ~3 minutes (full genome) |
| **Coverage** | ~18,200 designs / ~9,100 genes | ~18,200 designs / ~9,100 genes |

### M. thermophila Specifics
- **Species**: *Myceliophthora thermophila*
- **PAM**: NGG (SpCas9)
- **Genome**: 7 chromosomes, ~38.7 Mb
- **Genes**: 9,097 protein-coding genes
- **Status**: V2 validated, V3 tested with oligo=300bp, arm=119bp average
